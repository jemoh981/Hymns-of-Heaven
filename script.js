...
const defaultSongData = [
    { title: "Amazing Grace", genre: "thanksgiving", category: "General Hymn", lyrics: "Amazing grace! how sweet the sound,\nThat saved a wretch like me!\nI once was lost, but now am found,\nWas blind, but now I see.\n\n'Twas grace that taught my heart to fear,\nAnd grace my fears relieved;\nHow precious did that grace appear\nThe hour I first believed!" },
    ...
    { title: "Lord Jesus, Receive My Life", genre: "mass", category: "Communion Hymn", lyrics: "Lord Jesus, receive my life,\nThat I may serve you faithfully.\nTake my hands and make them yours,\nTake my heart and make it pure." },
